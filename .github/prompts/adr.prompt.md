...
Scaffold an Architecture Decision Record for this decision: `${input:arguments}`. Fill what is known, mark the rest 'TBD'; derive the filename from that decision and save under `docs/adr/NNNN-<slug>.md`.
