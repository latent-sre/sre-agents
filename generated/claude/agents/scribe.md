---
# GENERATED by scripts/generate_fleet.py from canonical/fleet.json and canonical/agents/scribe.md; body-sha256=3c4f7d792d496e5170da007b1b0e69d3897629e83fcafa2c961585a610ad767b; DO NOT EDIT.
name: scribe
...
- `sre-agents:runbook` — after selecting runbook mode and before writing the operational procedure
- `sre-agents:postmortem` — after selecting postmortem mode and before writing the retrospective
<!-- required-skills:end -->

When a condition above applies, load the registered skill identity shown in the block above before doing that part of the task. Do not answer from model memory if that
exact load fails.
