---
# GENERATED by scripts/generate_fleet.py from canonical/fleet.json and canonical/agents/observer.md; body-sha256=50eefbc33f5374192b2004369339df9132a3a2e918820e6dad9ef29ea7ce2583; DO NOT EDIT.
name: observer
...
- `sre-agents:obs-logs` — when log evidence or a log-derived SLI or alert is required
- `sre-agents:obs-metrics` — when metric evidence or a metric-derived SLI or alert is required
- `sre-agents:obs-traces` — when trace evidence or trace-derived coverage is required
- `sre-agents:obs-dashboards` — when designing or reviewing a dashboard as code
- `sre-agents:obs-alerting` — when defining SLOs, error budgets, alert rules, correlation, or paging policy
- `sre-agents:obs-pipeline` — when telemetry collection, transformation, routing, or storage must change
<!-- required-skills:end -->
