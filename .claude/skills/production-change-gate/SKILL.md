...
description: >-
  Use immediately before any production-facing or destructive action to confirm current human approval,
  blast radius, backout, executor, monitoring, and communications. Do not use as evidence that a build
  is release-ready.
---
